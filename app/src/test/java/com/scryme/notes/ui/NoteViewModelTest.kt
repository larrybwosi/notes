...
class NoteViewModelTest {
    ...
    @Test
    fun testCreateRootNote_InitializesWithDefaultParagraph() = runTest {
        // Act
    ...
    @Test
    fun testCreateChildNote_CorrectlySetsParentIdAndExpandsParent() = runTest {
    ...
    @Test
    fun testUpdateActiveNoteTitle_ReflectsInStateAndDao() = runTest {
        // Arrange
    ...
    @Test
    fun testBlockInsertion_AppearsDirectlyAfterActiveBlock() = runTest {
        // Arrange
    ...
    @Test
    fun testBlockDeletion_DoesNotRemoveLastBlockButResetsText() = runTest {
        // Arrange
    ...
    @Test
    fun testApplyStyleToSelection_CreatesInlineSpanStyle() = runTest {
        // Arrange
        viewModel.createRootNote("Page")
        testDispatcher.scheduler.advanceUntilIdle()
        val note = viewModel.activeNote.value!!
